...
QtObject {
    ...
    // y dos satélites laterales que muestran el anillo completo (overflow).
    readonly property int launcherGearStations: 8
    // mod 360 == 0
    readonly property real launcherGearRadius: 236
    readonly property real launcherGearToothH: 48
    readonly property real launcherCenterSize: 172 // hub circular (diámetro)
    readonly property real launcherSatellites: 3 // dientes por satélite
    readonly property real launcherSatRadius: 78
    readonly property real launcherSatGap: 46 // separación para que el satélite no se solape con el principal
    readonly property real launcherSatToothH: 17 // diente del satélite (satRadius * 0.22)
    readonly property real launcherSlotW: 84
    readonly property real launcherSlotH: 86
